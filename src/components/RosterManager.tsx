    ...
    <section className="max-w-6xl mx-auto px-4 py-6">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex gap-2">
          ...
          />
          <button className="btn-green-solid" onClick={add}>
            + Add
          </button>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.map((c) => {
          ...
          return (
            <div
              key={c.id}
              className={`card flex flex-col justify-between space-y-3 ${TEAM_BG_SOFT[team]} ${
            ...
            >
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2 items-end">
                      <div className="flex flex-col justify-between w-full min-w-20">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="btn-red-solid" onClick={() => remove(c.id)}>
                  Remove
                </button>
              </div>
            </div>
